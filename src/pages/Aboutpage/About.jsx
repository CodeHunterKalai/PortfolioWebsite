...
export const About = () => {
  ...
  const myName = 'Kalaiyarasan C';

  return (
     <>
          <h1 className="text-center mt-5">About me </h1>
          <p className='text-para text-center text-secondary'>Let's Know my journey in tech</p>
          <div className="about-container mb-5 mt-3 bg-primary">

         <div className="about-summary ">
          <p className="my-para text-white">
           👋 Hey! I’m {myName} I've recently completed my Bachelor degree in Computer Science from PMT Arts College.
